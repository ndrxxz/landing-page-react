...
const features = [
    {
        ...
        description: "Intelligent code suggestions powered by advanced AI that learns from your coding patterns. Get a real-time assistance with syntax, logic, and best practices.",
        codeSnippet: `
    ...
    },
    {
        ...
        description: "Generate comprehensive test suite automatically. Our AI analyzes your code and creates unit tests, integration tests, and edge case coverage.",
        codeSnippet: `
                        ...
                        >
                            ...
                            <div className="flex-1 w-full">
                                <div className="relative group">
                                    ...
                                    <div 
                                        className="relative bg-gray-900/50 backdrop-blur-sm border border-gray-700/50 rounded-xl sm:rounded-2xl p-4 sm:p-6 overflow-hidden group-hover:border group-hover:border-blue-600/50 transition-all duration-300"
                                    >
                                        {/* IDE Interface */}
