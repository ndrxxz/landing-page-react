const testimonials = [
    {
        name: "Juan Dela Cruz",
        role: "Lead Developer",
        image: "https://images.pexels.com/photos/34946637/pexels-photo-34946637.jpeg",
    ...
    },
    {
        ...
        image: "https://images.pexels.com/photos/21044809/pexels-photo-21044809.jpeg",
        content: "The automated testing and debugging features are game changers. We ship code faster and with more confidence than ever before."
    },
    {
        name: "Emily Santos",
        role: "CEO",
        image: "https://images.pexels.com/photos/13523528/pexels-photo-13523528.jpeg",
            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col lg:flex-row items-start gap-8 sm:gap-12 lg:gap-16">
                    ...
                    <div className="lg:w-1/2 w-full text-center lg:text-left">
                        ...
                        <p className="text-gray-400 text-xl sm:text-lg max-x-2xl mx-auto">
